...
export const postsApiSlice = createApi({
  ...
  tagTypes: ['Posts'],
  endpoints: (build) => ({
    getInfinitePosts: build.infiniteQuery<PostsWithAuthorResponse, GetPostsArgs, number>({
      ...
      async onCacheEntryAdded(arg, { cacheDataLoaded, cacheEntryRemoved, dispatch }) {
        ...
        try {
          ...
          const listener = (event: MessageEvent) => {
            ...
            dispatch(
              postsApiSlice.util.updateQueryData('getInfinitePosts', arg, (draft) => {
...
// useGetPostQuery is not used in the app, but it's available
export const { useGetInfinitePostsInfiniteQuery } = postsApiSlice;
